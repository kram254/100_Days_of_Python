...
class BenefitsEnrollmentForm:
    def __init__(self):
        ...
        ttk.Label(self.root, text="First Name:").grid(column=0, row=0, padx=10, pady=10)
        self.first_name = ttk.Entry(self.root)
        self.first_name.grid(column=1, row=0)

        ttk.Label(self.root, text="Last Name:").grid(column=0, row=1, padx=10, pady=10)
        self.last_name = ttk.Entry(self.root)
        self.last_name.grid(column=1, row=1)

        ttk.Label(self.root, text="Email:").grid(column=0, row=2, padx=10, pady=10)
        self.email = ttk.Entry(self.root)
        self.email.grid(column=1, row=2)

        ttk.Label(self.root, text="Address:").grid(column=0, row=3, padx=10, pady=10)
        self.address = ttk.Entry(self.root)
        self.address.grid(column=1, row=3)

        ttk.Label(self.root, text="Phone Number:").grid(column=0, row=4, padx=10, pady=10)
        self.phone_number = ttk.Entry(self.root)
        self.phone_number.grid(column=1, row=4)

        ttk.Label(self.root, text="Benefit Plan:").grid(column=0, row=5, padx=10, pady=10)
        self.benefit_plan = ttk.Combobox(self.root, values=["Plan A", "Plan B", "Plan C"])
    ...
    def submit_form(self):
        ...
        enrollment = BenefitsEnrollment(first_name=first_name, last_name=last_name, email=email, address=address, phone_number=phone_number, benefit_plan=benefit_plan)
        ...
        tk.messagebox.showinfo(title="Success", message="Your benefits enrollment form has been submitted!")
